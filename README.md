...
* **Clean Summaries:** Exports everything into a structured `CONTEXT.md` snippet.
* **Zero Overhead:** Runs in seconds right from your terminal.
* **Integrates with Waypoint:** Complements focus-driven developer tools by reducing context-switching fatigue.
---
## Quick Start
### Installation
```bash
